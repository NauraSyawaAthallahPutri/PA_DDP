            ...
            if kategori["Nama Kategori"].lower() == nama_kategori.lower():
                try:
                    ...
                    if not (2 <= len(nama_produk) <= 50 ):
                        ...
                        print("+======================================================+\n")
                        continue
                    elif any(produk["Nama Produk"].lower() == nama_produk.lower() for produk in kategori["produk"]):
                        print("+===================================================+")
                        print("| Produk tersebut sudah ada. Tolong pilih yang lain |")
                        print("+===================================================+\n")
                        continue
                    ...
                    if produk["ID"] == id_produk:
                        ...
                        while True:
                            ...
                            if not (2 <= len(nama_produk_baru) <= 50 ):
                                ...
                                print("+======================================================+\n")
                                continue
                            elif any(produk["Nama Produk"].lower() == nama_produk_baru.lower() for produk in kategori["produk"]):
                                print("+===================================================+")
                                print("| Produk tersebut sudah ada. Tolong pilih yang lain |")
                                print("+===================================================+\n")
                                continue
